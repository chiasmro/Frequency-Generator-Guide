...
* [Введение](#введение)
  * [Настройки приложения](#настройки-приложения)
    ...
    + [Одночастотный и многочастотный генератор](#одночастотный-и-многочастотный-генератор)
    + [Расширенные функции и дополнения](#расширенные-функции-и-дополнения)
    + [Пресеты и экспорт аудио](#пресеты-и-экспорт-аудио)
  * [Одиночная частота](#одиночная-частота)
  * [Многочастотный генератор](#многочастотный-генератор)
  * [Синтезатор](#синтезатор)
  * [Бинауральные ритмы](#бинауральные-ритмы)
  * [Частота развёртки](#частота-развёртки)
  * [Генератор шума](#генератор-шума)
  * [Низкочастотные](#низкочастотные)
  * [Удалить воду](#удалить-воду)
  * [DTMF](#dtmf)
...
## Введение
Данное руководство предназначено для упрощения понимания работы приложения пользователями. Приложение доступно только для пользователей **Android**! Бесплатная версия приложения имеет достаточный функционал для генерации звуковых частот (одночастотный и многочастотный генератор, синтезатор, генератор шума, и т.д.). Также вы можете приобрести Pro-версию приложения с расширенными функциями:
![Pro](../../images/pro.jpg)
...
_Рисунок 2: Открытое подменю_
### Общие настройки
![Общие настройки](../../images/settings_general_fixed.jpg)
...
В данном разделе, для прослушивания бинауральных ритмов, доступны изменение основной частоты от 21 до 1200 Герц и биения от 0 до 40 Герц. При нажатии на три точки в правом верхнем углу вам открывается такое же подменю как в рисунке 2, с теми же функциями. При нажатии на кнопку <img src="../../icons/icon1.png" alt="Громкость" width="32" height="32"> вам открывается вкладка, где вы можете изменить громкость звука. При нажатии на кнопку <img src="../../icons/icon5.png" alt="Предложения" width="32" height="32"> вам откроется вкладка с отдельными предложениями в виде комбинаций основных частот и биений:
![Предложения по бинауральным ритмам](../../images/binaural_o.jpg)
_Рисунок 19: Предложения для пользователя в виде отдельных комбинаций бинауральных ритмов_

> [!NOTE]
> Для прослушивания бинауральных ритмов рекомендуется использовать наушники.

## Частота развёртки
![Частота развёртки](../../images/scan_frequency.jpg)
_Рисунок 20: Раздел "Частота развёртки"_

В данном разделе воспроизводится звук, изменяющийся с одной заданной пользователем частоты на другую, в течение заданного времени. Доступна возможность включить и отключить **Петлю** - приложение начнёт циклически переключать звук между двумя частотами (туда и обратно).

## Генератор шума
![Генератор шума](../../images/noise.jpg)
_Рисунок 21: Раздел "Генератор шума"_

Этот раздел позволяет воспроизводить белый, розовый, и коричневый шум с использованием эффекта **Auto-pan (stereo)**.
> [!NOTE]
> Для прослушивания синего, фиолетового, серого шума, и использования эффекта **Breathing** требуется Pro-версия приложения.

## Низкочастотные
![Низкие частоты](../../images/low_freq.jpg)
_Рисунок 22: Раздел "Низкочастотные"_

Здесь доступны несколько вариантов для воспроизведения низких частот, на усмотрение пользователя.
> [!NOTE]
> Используйте сабвуферы или наушники для тестирования звука.

## Удалить воду
![Удалить воду](../../images/remove_water.jpg)
_Рисунок 23: Раздел "Удалить воду"_

Если вода попала в динамики телефона, чтобы избавиться от неё, вы можете использовать данную функцию. Нажмите на кнопку **Удалить воду**
 и следуйте инструкции:
 
![Удаление воды](../../images/remove_water2.jpg)
_Рисунок 24: Инструкция по очистке_

## DTMF
![DTMF-сигналы](../../images/DTMF.jpg)
_Рисунок 25: Меню DTMF-сигналов_

DTMF (Dual-Tone Multi-Frequency) — это метод сигнализации в телекоммуникационных системах, который использует комбинацию двух разных частот для передачи информации через голосовой канал. Технология позволяет кодировать символы (цифры, буквы, специальные знаки) в аналоговые сигналы, которые затем передаются по линиям связи. 

## Звуковые эффекты
![Звуковые эффекты](../../images/sound_effects.jpg)
_Рисунок 26: Меню со звуковыми эффектами_

В данном небольшом разделе представлены звуковые эффекты:
- **Монета**
- **Лазер**
- **Взрыв**
- **Прыжок**
...
Имеется возможность воспроизводить тот или иной эффект заново, и сохранить его в смартфон.
